...
# .github/workflows/release.yml renders this on every v* tag — swapping https://github.com/manwray/homebrew-tickle/releases/download/v0.6.6/tickle-0.6.6-darwin-universal.tar.gz,
# 46a5d4cd669eb73251f454fd38ebb14e333b26c41538da0ca098d2f26ec9920c, 0.6.6 for the just-published darwin universal tarball — and pushes
...
class Tickle < Formula
  ...
  url "https://github.com/manwray/homebrew-tickle/releases/download/v0.6.6/tickle-0.6.6-darwin-universal.tar.gz"
  sha256 "46a5d4cd669eb73251f454fd38ebb14e333b26c41538da0ca098d2f26ec9920c"
  version "0.6.6"
  license "MIT"
