...
# .github/workflows/release.yml renders this on every v* tag — swapping https://github.com/manwray/homebrew-tickle/releases/download/v0.6.9/tickle-0.6.9-darwin-universal.tar.gz,
# fc92987e9c18632114d1cce4e9d65216b187cbad15d5a1b97f0a97b1d072bdd6, 0.6.9 for the just-published darwin universal tarball — and pushes
...
class Tickle < Formula
  ...
  url "https://github.com/manwray/homebrew-tickle/releases/download/v0.6.9/tickle-0.6.9-darwin-universal.tar.gz"
  sha256 "fc92987e9c18632114d1cce4e9d65216b187cbad15d5a1b97f0a97b1d072bdd6"
  version "0.6.9"
  license "MIT"
